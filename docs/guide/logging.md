...
> **Protocol context** — This guide covers Stacks.js logging in relation to the draft [Observability contract](https://github.com/stacksjs/white-paper#54-observability). Exporters and exact APIs remain implementation-specific.
